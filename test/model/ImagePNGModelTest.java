...
public class ImagePNGModelTest {
  ...
  public void testColorCorrection() {
    ...
    image.storePixels("expected-cc-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-color-correction.png"));
    expectedPixels = image.getStoredPixels("expected-cc-key");

    assertImageEquals(convertToRGBPixelArray(expectedPixels),
        convertToRGBPixelArray(operationPixels));
  }
  ...
  public void testCompression() {
    ...
    image.storePixels("expected-comp-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-compressed-50.png"));
  ...
  public void testLevelsAdjust() {
    ...
    image.storePixels("expected-levels-adjust-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-levels-adjust.png"));
  ...
  public void testSplitAndTransformBlur() {
    ...
    image.storePixels("expected-split-blur-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-split-blur-50.png"));
  ...
  public void testSplitAndTransformSepia() {
    ...
    image.storePixels("expected-split-sepia-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-split-sepia-80.png"));
  ...
  public void testSplitAndTransformLevelsAdjust() {
    image.splitAndTransform("testKey", "split-levels-adjust-key", 25, "levels-adjust", 20, 100,
        255);
    operationPixels = image.getStoredPixels("split-levels-adjust-key");
    image.storePixels("expected-split-levels-adjust-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-split-levels-adjust-25.png"));
  ...
  public void testMultipleOperationsSharpenBrightenBy50() {
    ...
    image.storePixels("expected-combination-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-multiple-operations.png"));
  ...
  public void testMultipleOperationsCompressBy50LevelsAdjustHistogram() {
    ...
    operationPixels = image.getStoredPixels("histogram-key");
    image.storePixels("expected-histogram-key",
        ImageUtil.loadImage("test/Test_Image/png_op/Landscape-compress-histogram.png"));
    expectedPixels = image.getStoredPixels("expected-histogram-key");
