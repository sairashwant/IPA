 ...
 * This class contains the `main` method which determines the mode of the application based on the provided arguments:
 * - Launches a GUI if no arguments are provided.
 * - Runs a script if the `-file` argument with a file path is provided.
 * - Launches an interactive command-line interface if the `-text` argument is provided.
 * If the arguments are invalid, a message is displayed to guide the user.
 */
public class Main {
   ...
   * <p>If the argument `-file <file path>` is provided, it runs a script located at the specified path.</p>
   * <p>If the argument `-text` is provided, it launches the interactive command-line interface.</p>
   ...
   * Creates instances of the necessary models, controllers, and the GUI, and launches the GUI on the Event Dispatch Thread.
   */
  ...
  /**
   * Runs a script located at the specified file path.
   * The script contains commands that are processed by the image controller.
   *
  ...
  /**
   * Launches the interactive command-line mode for the image processing application.
   * The user is presented with a menu of available operations, and the application waits for the user's input to process commands.
   */
