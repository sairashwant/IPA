...
/**
 * The ImageController class provides an interface to control various image processing operations on
 * an Image object. It handles loading, saving, and applying a variety of transformations and
...
public class ImageController {
  ...
  /**
   * Constructs an ImageController with the given Image model and initializes a set of supported
   * image operations.
   *
  ...
  public ImageController(Image image) {
    ...
    Map<String, TriConsumer<String, Integer, String>> bOperations = new HashMap<>();
  ...
  /**
   * Splits an image into its red, green, and blue channels and stores them under the provided save
   * keys.
   *
  ...
  /**
   * Combines the red, green, and blue channels stored under the provided keys into a single image.
   *
