 ...
 * This transformation is typically used for image processing tasks that require brightness
 * adjustments or grayscale conversions.</p>
 */
public class Luma extends AbstractBasicOperation {
   ...
   * most
   * to the brightness, followed by red and blue. This calculation reflects the human eye's
