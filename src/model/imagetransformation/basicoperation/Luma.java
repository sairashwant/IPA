 ...
 *
 * <p>Luma is a weighted calculation of the red, green, and blue components of a pixel. It is used
 * to determine the perceived brightness of the pixel, with different weights for each color
 * component. This transformation is typically used for image processing tasks that require
 * brightness adjustments or grayscale conversions.</p>
 */
public class Luma extends AbstractBasicOperation {
   ...
   * </pre>
   *
   * <p>The formula applies different weights to each color component, with green contributing the
   * most to the brightness, followed by red and blue. This calculation reflects the human eye's
   * sensitivity to these colors, making green the most important component for perceived
   * brightness.</p>
   *
