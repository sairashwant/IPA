 ...
 * that flips an image either horizontally or vertically based on the specified direction. It takes
 * an image from a given key in a HashMap and returns the flipped version.
 */
public class Flip extends AbstractBasicOperation {
  ...
  /**
   * Flips the image stored in the given key either horizontally or vertically depending on the
   * specified direction.
   *
