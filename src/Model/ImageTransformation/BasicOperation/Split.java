...
/**
 * The Split class is responsible for splitting an image's RGB channels into three separate channels:
 * red, green, and blue. Each channel will be represented as an image where only the corresponding
 * color information is retained (the other two channels are set to the same value as the target channel).
 */
public class Split extends AbstractBasicOperation {

  /**
   * Splits the given image into its red, green, and blue channels. Each resulting channel will contain
   * the respective color value, with the other two channels being the same as the target channel value.
   *
   ...
   * @return a HashMap containing the red, green, and blue channel images, stored under saveKey1, saveKey2, and saveKey3 respectively
